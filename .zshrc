...
# Quick cd into workspace projects
export WORKSPACE="${WORKSPACE:-$HOME/workspace}"
ws() { cd "$WORKSPACE/$1" }
compdef '_files -W $WORKSPACE -/' ws

alias gs='git status'

# Docker dev container functions (from dockerfiles repo)
[[ -f "$HOME/workspace/dockerfiles/functions.sh" ]] && source "$HOME/workspace/dockerfiles/functions.sh"
